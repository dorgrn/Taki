const manager = (function () {
    ...
    var _eventPlayerChanged = "playerChanged";
    ...
    return {
        ...
        //eventPlayerChanged: new CustomEvent("playerChanged", { detail: Player }),

        getEventPlayerChanged: function() {
            return _eventPlayerChanged;
        },
        ...
        createPlayers: function () {
            manager.players.push(new Player("user"));
            manager.players.push(new Player("pc"));
        },
        ...
        init: function () {
            ...
            // choose first player
            var player = manager.players[manager.playerTurn];
            var eventPlayerChanged = new CustomEvent(_eventPlayerChanged, { detail: {player: player} });
            manager.dispatchEvent(eventPlayerChanged);
            player.doTurn();
        },

        switchTurn: function() {
            // algorithm: checks if the current player has 0 cards.
            // if he does have 0 cards left then game over.
            // else, manager need to move to next player index and preform doTurn
