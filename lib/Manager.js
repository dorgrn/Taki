var manager = (function () {
    ...
    return {
        ...
        putCard: function (card) {
            ...
            manager.onPutCardInPlayZone.notify({cardId: card.cardId});
        ...
        swapPlayer: function () {
            ...
            manager.onPlayerChanged.notify({currentPlayer : currentPlayer});
        ...
        makeNextTurn: function () {
            ...
            if (manager.isGameEnd()) {
                manager.onGameEnded.notify({currentPlayer : manager.getActivePlayer()});
                return;
            }
