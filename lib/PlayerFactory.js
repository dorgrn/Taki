    ...
    return {
        ...
        createPlayer: function (type) {
            ...
            player.getAvgTurnTime = function () {
                var playTime = player.turnStopWatch.getElapsedTimeInMillis();
                var turnAmount = player.stats.turnAmount;
                return (turnAmount === 0 ? 0 : stopWatchFactory.millisToMinutesAndSeconds(playTime / turnAmount));
            };
